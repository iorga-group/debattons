package com.iorga.debattons.config.timezone;

import com.iorga.debattons.DebattonsApp;
import com.iorga.debattons.repository.timezone.DateTimeWrapper;
import com.iorga.debattons.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM dbt_date_time_wrapper where id=%d", fieldName, id);
    }
