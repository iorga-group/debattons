...
import { DbtLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
  describe('LoginComponent', () => {
    let comp: DbtLoginModalComponent;
    let fixture: ComponentFixture<DbtLoginModalComponent>;
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [DbtLoginModalComponent],
        providers: [
          FormBuilder,
          {
        ...
        .overrideTemplate(DbtLoginModalComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(DbtLoginModalComponent);
