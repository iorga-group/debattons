...
import { DebattonsCoreModule } from 'app/core';
import { DebattonsAppRoutingModule } from './app-routing.module';
import { DebattonsHomeModule } from './home/home.module';
import { DebattonsAccountModule } from './account/account.module';
...
@NgModule({
  imports: [
    BrowserModule,
    NgxWebstorageModule.forRoot({ prefix: 'dbt', separator: '-' }),
    ...
    DebattonsSharedModule.forRoot(),
    DebattonsCoreModule,
    DebattonsHomeModule,
    DebattonsAccountModule,
    // jhipster-needle-angular-add-module JHipster will add new module here
    DebattonsEntityModule,
