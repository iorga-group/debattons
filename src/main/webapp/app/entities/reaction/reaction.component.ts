...
export class ReactionComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.reactionService
      ...
      .subscribe(
        (res: HttpResponse<IReaction[]>) => this.paginateReactions(res.body, res.headers),
  ...
  registerChangeInReactions() {
    this.eventSubscriber = this.eventManager.subscribe('reactionListModification', response => this.loadAll());
  }
  ...
  protected paginateReactions(data: IReaction[], headers: HttpHeaders) {
