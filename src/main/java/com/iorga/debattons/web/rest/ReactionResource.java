...
public class ReactionResource {
    ...
    public ResponseEntity<List<Reaction>> getAllReactions(@PathVariable Long parentReactionId, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
